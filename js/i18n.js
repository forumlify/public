...
const TRANSLATIONS = {
  'zh': {
    ...
    // ===== 确认对话框 =====
    // showConfirm() 动态创建 DOM，i18n 的 MutationObserver 会翻译其
    // 文本节点，但这些文案必须先在词典登记才能命中。
    '请确认': '请确认',
    '确定': '确定',
    '删除回复': '删除回复',
    '删除友链': '删除友链',
    ...
    '已关闭注册邮箱验证': '已关闭注册邮箱验证',
    '加载配置失败：': '加载配置失败：',
    '已保存密码，留空则不修改': '已保存密码，留空则不修改',
    '尚未设置密码': '尚未设置密码',
    '留空表示不修改已保存的密码': '留空表示不修改已保存的密码',
    '通常为完整邮箱地址': '通常为完整邮箱地址',
    '例如：论坛名称': '例如：论坛名称',
    '注册验证码': '注册验证码',
    '密码重置验证码': '密码重置验证码',
  ...
  'en': {
    ...
    '屏蔽用户': 'Block User',
    '已屏蔽该用户': 'User blocked',
    '已解除屏蔽': 'User unblocked',
    '还没有屏蔽任何人': 'You have not blocked anyone',
    '加载中…': 'Loading…',
    '加载失败': 'Failed to load',
    ...
    '清除密码': 'Clear Password',
    '注册邮箱验证': 'Email Verification on Signup',
    '要求注册时验证邮箱': 'Require email verification on signup',
    '获取验证码': 'Get Code',
    '邮箱验证码': 'Email Code',
    '配置完整，可以发信': 'Configuration complete, email is ready',
    '尚未配置完成，邮件功能不可用': 'Configuration incomplete, email is unavailable',
    '验证码已发送，请查收邮件': 'Verification code sent, please check your inbox',
    ...
    '本站未开启邮箱验证': 'Email verification is not enabled on this site',
    ...
    '已开启注册邮箱验证': 'Email verification on signup enabled',
    '已关闭注册邮箱验证': 'Email verification on signup disabled',
    '加载配置失败：': 'Failed to load settings: ',
    '已保存密码，留空则不修改': 'Password saved, leave blank to keep it',
    '尚未设置密码': 'No password set yet',
    '留空表示不修改已保存的密码': 'Leave blank to keep the saved password',
    '通常为完整邮箱地址': 'Usually your full email address',
    '例如：论坛名称': 'e.g. Forum name',
